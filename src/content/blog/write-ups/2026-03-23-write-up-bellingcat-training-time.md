...
The [challenge](https://challenge.bellingcat.com/) is to identify the name of the room seen in the photo.
...
By expanding the search to other rooms in the same venue, we stumbled upon photos of *[The Grand Ballroom* at the Mövenpick Resort Dead Sea](https://movenpick.accor.com/en/middle-east/jordan/dead-sea/resort-dead-sea/meeting-rooms/the-grand-ball-room.html), where Triebert hosted his workshop. The distinctive floor and wall design matched perfectly with the background in the ARIJ photo.
