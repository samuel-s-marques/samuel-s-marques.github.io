...
modDatetime: 2026-03-26
title: "Write-up: Metasploitable 2 | Bruteforce and Credential Stuffing"
ogImage: "Write-up: Metasploitable 2 | Bruteforce and Credential Stuffing"
slug: metasploitable-2-bruteforce
featured: true
draft: true
tags:
  - exploit
  ...
  - easy
  - bruteforce
description: Bruteforcing our way in on Metasploitable 2. Metasploitable 2 is a
  deliberately vulnerable virtual machine designed for practicing penetration
  testing. It contains outdated software and misconfigurations that make it
  ideal for learning exploitation techniques.
---
Check out the previous Metasploitable 2 write-up here, covering web apps exploitation: [Write-up: Metasploitable 2 | Web Apps | Samuel M.](https://samuelmarques.dev/posts/metasploitable-2-web-apps/)
...
**Objective:** While Metasploitable 2 contains dozens of vulnerabilities, this write-up focuses exclusively on the exploitation of the **Web Apps** available on the machine. The goal is to...
...
- [Write-up: Metasploitable 2 | Web Apps | Samuel M.](https://samuelmarques.dev/posts/metasploitable-2-web-apps)
